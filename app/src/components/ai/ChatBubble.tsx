...
const styles = StyleSheet.create({
  ...
  textAI: { color: Colors.inkInv, fontFamily: 'NotoSansKR_400Regular' },
  textUser: { color: Colors.ink1, fontFamily: 'NotoSansKR_600SemiBold' },
  textError: { color: Colors.coralSoft, fontFamily: 'NotoSansKR_400Regular' },
