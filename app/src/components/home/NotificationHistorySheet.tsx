...
const styles = StyleSheet.create({
  ...
  emptyTitle: { fontSize: 15, fontFamily: 'NotoSansKR_700Bold', color: Colors.ink2 },
  ...
  sectionTitle: { fontSize: 11, fontFamily: 'NotoSansKR_700Bold', letterSpacing: 1.2, textTransform: 'uppercase', color: Colors.ink3 },
  ...
  itemTitle: { fontSize: 14, fontFamily: 'NotoSansKR_700Bold', color: Colors.ink1 },
