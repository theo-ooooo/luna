...
const styles = StyleSheet.create({
  ...
  dayNum: { fontSize: 28, fontWeight: '900', letterSpacing: -1.1, color: Colors.ink1 },
  dayOf: { fontSize: 9, fontWeight: '700', letterSpacing: 1.6, color: Colors.ink3, marginTop: 2 },
  info: { flex: 1 },
  eyebrow: { fontSize: 11, fontWeight: '700', letterSpacing: 1.5, textTransform: 'uppercase', color: Colors.ink3 },
  pct: { fontSize: 22, fontWeight: '800', letterSpacing: -0.8, marginTop: 4, color: Colors.ink1 },
