...
export function InsightsBody({ chartW, scrollable = false }: Props) {
...
const styles = StyleSheet.create({
  ...
  aiCardEyebrow: { fontSize: 11, fontFamily: 'NotoSansKR_700Bold', color: Colors.ink1, letterSpacing: 0.6 },
  aiCardText: { fontSize: 14, lineHeight: 22, color: Colors.ink1, fontFamily: 'NotoSansKR_600SemiBold', letterSpacing: -0.1 },
  aiCardTextMuted: { fontSize: 13, lineHeight: 20, color: Colors.ink2, fontFamily: 'NotoSansKR_500Medium', letterSpacing: -0.1 },

  kpiRow: { flexDirection: 'row', gap: 10 },
  kpiTile: { flex: 1, borderRadius: Radius.tile, padding: TILE_PADDING, minHeight: 110, justifyContent: 'space-between' },
  kpiLabel: { fontSize: 10, fontFamily: 'NotoSansKR_700Bold', letterSpacing: 1.2, textTransform: 'uppercase', color: Colors.ink1 },
  kpiValueRow: { flexDirection: 'row', alignItems: 'baseline', gap: 3 },
  kpiValue: { fontSize: 36, fontFamily: 'NotoSansKR_900Black', letterSpacing: -2 },
  kpiUnit: { fontSize: 14, fontFamily: 'NotoSansKR_700Bold' },

  tile: { backgroundColor: Colors.bgCard, borderRadius: Radius.tile, padding: TILE_PADDING },
  tileHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: 14 },
  tileEyebrow: { fontSize: 10, fontFamily: 'NotoSansKR_700Bold', letterSpacing: 1.2, textTransform: 'uppercase', color: Colors.ink3, marginBottom: 4 },
  tileTitle: { fontSize: 18, fontFamily: 'NotoSansKR_800ExtraBold', letterSpacing: -0.4, color: Colors.ink1 },
  tileMeta: { fontSize: 10, color: Colors.ink3, fontFamily: 'NotoSansKR_600SemiBold', letterSpacing: 0.4 },

  chartLegend: { flexDirection: 'row', gap: 12, marginTop: 4 },
  legendItem: { flexDirection: 'row', alignItems: 'center', gap: 5 },
  legendLine: { width: 8, height: 2, borderRadius: 1 },
  legendText: { fontSize: 10, color: Colors.ink3, fontFamily: 'NotoSansKR_500Medium' },

  tileEmpty: { fontSize: 13, color: Colors.ink3, fontFamily: 'NotoSansKR_500Medium', marginTop: 8, lineHeight: 20 },

  heatmapGrid: { gap: 4, marginTop: 8 },
  heatmapRow: { flexDirection: 'row', alignItems: 'center', gap: 3 },
  heatmapLabel: { width: 42, fontSize: 11, fontFamily: 'NotoSansKR_600SemiBold', color: Colors.ink1 },
  ...
  barValue: { fontSize: 11, fontFamily: 'NotoSansKR_700Bold', color: Colors.ink2 },
  barValueLatest: { color: Colors.coral },
  barFill: { width: '100%', borderRadius: 6 },
  barLabel: { fontSize: 9, color: Colors.ink3, fontFamily: 'NotoSansKR_600SemiBold' },
});
