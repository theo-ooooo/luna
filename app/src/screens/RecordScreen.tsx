...
const styles = StyleSheet.create({
  ...
  aiLabel: { fontSize: 11, fontFamily: 'NotoSansKR_700Bold', letterSpacing: 1.2, textTransform: 'uppercase', color: Colors.ink3 },
  ...
  aiBtnText: { fontSize: 16, color: Colors.inkInv, fontFamily: 'NotoSansKR_700Bold' },
  ...
  heroDate: { fontSize: 11, fontFamily: 'NotoSansKR_700Bold', color: 'rgba(242,238,232,0.5)', letterSpacing: 1.2, textTransform: 'uppercase', textAlign: 'center', flex: 1 },
  dateNavBtn: { width: 32, height: 32, alignItems: 'center', justifyContent: 'center' },
  dateNavBtnDisabled: { opacity: 0.25 },
  heroTitle: { fontSize: 28, fontFamily: 'NotoSansKR_900Black', letterSpacing: -1, color: Colors.inkInv },
  ...
  bbtInput: { flex: 1, fontSize: 36, fontFamily: 'NotoSansKR_900Black', letterSpacing: -1, color: Colors.ink1, paddingVertical: 4, borderBottomWidth: 2, borderBottomColor: Colors.borderSoft },
  bbtUnit: { fontSize: 18, fontFamily: 'NotoSansKR_700Bold', color: Colors.ink3 },
  ...
  tagChipText: { fontSize: 13, fontFamily: 'NotoSansKR_600SemiBold', color: Colors.ink2 },
