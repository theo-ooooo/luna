...
const styles = StyleSheet.create({
  ...
  settingLabel: { flex: 1 },
  settingLabelText: { fontSize: 14, fontFamily: 'NotoSansKR_600SemiBold', color: Colors.ink1 },
  settingDetail: { fontSize: 11, color: Colors.ink3, marginTop: 2 },
  textInput: { fontSize: 14, fontFamily: 'NotoSansKR_600SemiBold', color: Colors.ink1, textAlign: 'right', minWidth: 100 },
  ...
  stepValue: { fontSize: 16, fontFamily: 'NotoSansKR_800ExtraBold', color: Colors.ink1, minWidth: 28, textAlign: 'center' },
