...
import { OnboardingPeriodLenScreen } from '../screens/onboarding/OnboardingPeriodLenScreen';
...
export type OnboardingStackParamList = {
  ...
  PeriodLen: { cycleLen: number; lastPeriodDate: string | null };
  Nickname: { cycleLen: number; periodLen: number; lastPeriodDate: string | null };
};
...
export function OnboardingNavigator() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false, animation: 'slide_from_right' }}>
      ...
      <Stack.Screen name="PeriodLen" component={OnboardingPeriodLenScreen} />
