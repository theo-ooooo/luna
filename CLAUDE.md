...
오케스트레이터는 **PR 생성 직후** 반드시 reviewer와 QA를 **동시에** 실행한다. 블로커·개선권고 수정 후 재커밋이 push될 때도 **즉시 재실행**한다. 유저 별도 지시 불필요. `agents/reviewer.md`, `agents/qa.md` 참조.
